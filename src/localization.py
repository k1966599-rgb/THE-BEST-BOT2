...
TEXTS = {
    "AR": {
        ...
        # --- Monitoring ---
        "ask_what_to_do": "ماذا تريد أن تفعل بهذا التحليل؟",
        "button_monitor_follow": "📈 متابعة الصفقة",
        "button_monitor_ignore": "🗑️ تجاهل",
        "monitoring_started": "✅ تم تفعيل المراقبة لـ *{symbol}*. سأقوم بتنبيهك عند اقتراب السعر من المستويات الرئيسية.",
        "monitoring_ignored": "تم تجاهل التحليل.",
        "alert_level_hit": "🚨 **تنبيه ملامسة مستوى** 🚨\n\n- **العملة:** `{symbol}`\n- **لامس السعر:** `{current_price}`\n- **مستوى:** `{level_name}` ({level_price})",
