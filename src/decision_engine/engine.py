...
class DecisionEngine:
    ...
    def make_recommendation(self, analysis_results: Dict[str, Any], df: pd.DataFrame, symbol: str, timeframe: str, chat_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        if patterns:
            ...
            if chat_id:
                try:
                    # Pass the dataframe with indicators to the condition generator
                    ...
                    trade_setup = TradeSetup(
                        ...
                        confirmation_rule='3_candle_close', # Set the rule here
    ...
    def _generate_confirmation_conditions(self, df: pd.DataFrame, analysis: Dict[str, Any], pattern: Pattern) -> (List[str], List[str]):
        ...
        # --- Optional, indicator-based conditions ---
        optional_conditions = []
        # Check for OBV (On-Balance Volume)
        ...
        # Check for ATR
        if 'atrp_14' in df.columns: # pandas-ta uses 'ATRp_14' for percentage
